...
type PokemonResponseObject struct {
	ID             int    `json:"id"`
	Name           string `json:"name"`
...
func handleRequests[T any](url string, resultBody T) T {
...
func GetLocation(url string) LocationResponseObject {
	var resultBody LocationResponseObject
	return handleRequests(url, resultBody)
}
...
func GetPokemon(pokemonName string) PokemonResponseObject {
